...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Script",Text = "kurd hub",Duration = 1;})
	return
end
local version = 2
--VARIABLES
...
Animations_Section_Button.Text = "هاکی یاریەکان"
...
VampireAnim_Button.Text = "یاری blade ball"
...
ZombieClassicAnim_Button.Text = "یاری MM2"
...
MageAnim_Button.Text = "blox fruit ئەندروید"
...
GhostAnim_Button.Text = "blox fruit ئایفون"
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Script",Text = "Welcome to kurd Hub !",Icon = "rbxassetid://18938089746",Duration = 15})
...
VampireAnim_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://pastebin.com/raw/LzHhhvkJ'))()
end)
...
MageAnim_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://pastebin.com/raw/v9TnReUW'))()
end)
...
AntiChatSpy_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://pastebin.com/raw/wC64LrAJ'))()
end)
